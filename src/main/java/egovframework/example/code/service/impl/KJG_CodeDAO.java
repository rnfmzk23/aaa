...
@Repository("codeDAO")
public class KJG_CodeDAO extends EgovAbstractDAO {
	...
	public KJG_CodeVO selectCode(KJG_CodeVO vo) throws Exception {
		return (KJG_CodeVO) select("codeDAO.selectCode", vo);
	}
	...
	public List<?> selectCodeList(KJG_CodeDefaultVO csearchVO) throws Exception {
		return list("codeDAO.selectCodeList", csearchVO);
	}
	...
	public int selectCodeListTotCnt(KJG_CodeDefaultVO csearchVO) {
		return (Integer) select("codeDAO.selectCodeListTotCnt", csearchVO);
	}
